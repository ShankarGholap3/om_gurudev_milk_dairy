...
#include <analogic/ws/supervisor/supervisorconfig.h>
#include <analogic/ws/supervisor/supervisorhandler.h>
 ...
 * \brief   This class contains functionality related to receiving  data from NAL and providing it to the UI
 */
class SupervisorManager : public WorkstationManager
{
  Q_OBJECT
public:
  /*!
  ...
  /*!
    ...
    *           nss service.
    */
  void RegistrationChanged(analogic::nss::SupervisorAgent *agent);
